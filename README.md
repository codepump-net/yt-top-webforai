...
- **[2026-09-25 환자 목적별 메뉴·화면 개편](docs/patient-navigation-2026-09-25/README.ko.md)** — 로컬 개발 범위 74개 경로. 7개 메뉴, 4개 진입로, 좌측 목차와 두 백과 탐색. 별도 220편 원고 연결은 원고 위치 확인 후 진행합니다.
